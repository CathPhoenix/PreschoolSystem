...
public class ReportsView extends JFrame implements ListSelectionListener  {
	...
	public ReportsView(MainScreen frame){
	
		this.frame=frame;
		
		
		JPanel topPanel = (Design.buildTopPanel("Which student do you want to file a report for?"));
		...
		frame.swapPanelCards.add(wrapPanel, "ReportsView");
	}
